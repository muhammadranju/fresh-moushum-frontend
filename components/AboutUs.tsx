...
export default function AboutUs() {
  ...
  const sectionImage = isValidUrl(content.imageUrl) ? content.imageUrl.trim() : defaultContent.imageUrl;
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-10 bg-primary text-white p-10 rounded-[40px] shadow-2xl z-20 hidden md:block">
              ...
              <div className="text-sm opacity-80 uppercase tracking-widest">বছরের অভিজ্ঞতা</div>
            </div>
          ...
          >
            ...
            <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div>
                  <h4 className="text-primary font-black text-2xl mb-1">৫০০+</h4>
                  <p className="text-sm text-slate-500 font-bold uppercase">নিজস্ব বাগান পার্টনার</p>
                </div>
                <div>
                  <h4 className="text-primary font-black text-2xl mb-1">১০০%</h4>
                  <p className="text-sm text-slate-500 font-bold uppercase">ফরমালিন মুক্ত</p>
                </div>
              </div>
            </div>
          </motion.div>
